...
import {
    Navbar, NavbarBrand, Nav, NavItem, NavbarToggler, Collapse, Jumbotron, Form, FormGroup, Input, Label,
                        ...
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>
                                    ...
                                    fusion experience. Our lipsmacking creations will tickle your culinary senses!
                                </p>
                            </div>
                        </div>
                    </div>
